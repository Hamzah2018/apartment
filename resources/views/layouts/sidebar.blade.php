        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    {{-- <li><a class="slide-item" href="{{ url('/' . $page='product-details') }}">حسابة الطالبي الشقق</a></li> --}}
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/' . $page='apartment') }}">الشقق المحجوزه</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/' . $page='apartment') }}">الشقق المتاحه  </a></li>
