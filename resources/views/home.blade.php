  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link p-2 p-lg-3" href="#broker" >السماسره</a>
            </li>
            <li class="nav-item">
              <a class="nav-link p-2 p-lg-3" href="#apartment">الشقق</a>
            </li>
            <li class="nav-item">
          ...
          <div>
          <a class="btn rounded-pill main-btn" href="{{ url('/register') }}">تسجيل</a>
        </div>
        <div>
    ...
    <div class="features text-center pt-5 pb-5">
      <div class="container">
        <div class="main-title mt-5 mb-5 position-relative">
          ...
          <h2 id="broker">بعظ السماسره المعتمدين</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 ">
            <div class="feat shadow p-3 mb-5 bg-body rounded">
              ...
              <h4 class="mb-3 mt-3 text-uppercase">{{ $u->name }}</h4>
    ...
    <div class="our-work text-center pt-5 pb-5">
      <div class="container">
        <div class="main-title mt-5 mb-5 position-relative">
          <img class="mb-4" src="{{URL::asset('assets/mydesign/imgs/title.png')}}" alt="" />
          <h2 id="apartment">بعض الشقق المتحه</h2>
